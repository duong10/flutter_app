...
class $AssetsIconsGen {
  ...
  /// File path: assets/icons/icRotateLeft.svg
  String get icStore => 'assets/icons/ic_store.svg';
...
class $AssetsImagesGen {
  ...
  /// File path: assets/images/im_bg_branch.png
  AssetGenImage get imBgBranch =>
      const AssetGenImage('assets/images/im_bg_branch.png');

  /// List of all assets
  List<AssetGenImage> get values => [imBgBranch];
}
